    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(onTap: (index){
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.favorite_border_outlined,color: currentIndex==1? Color(0xFF8204FF):Colors.black),label: "notification"),
          BottomNavigationBarItem(icon: Icon(Icons.settings,color: currentIndex == 2 ? Color(0xFF8204FF) : Colors.black),label: "cart"),
          BottomNavigationBarItem(icon: Icon(Icons.email_outlined,color: currentIndex == 3 ? Color(0xFF8204FF) : Colors.black),label: "account")
