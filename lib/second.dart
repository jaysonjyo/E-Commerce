                    ...
                    children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.minimize_sharp,color: Color(0xFF8204FF),),
                              Padding(
                                padding: const EdgeInsets.only(left: 10,top: 8),
                                child: Text("1",style: TextStyle(color:Color(0xFF8204FF),fontSize: 25),),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(left: 10,top: 10),
                                child: Icon(Icons.add,color: Color(0xFF8204FF),),
                              )
                      ...
                      SizedBox(width: 10.w,),
                      CircleAvatar(radius: 25.r,backgroundColor: Color(0xFFE5DCFC),
                          child: Icon(Icons.favorite_border_outlined,color: Color(0xFF8204FF),))
                    ],
                  ),
                ),
              )
